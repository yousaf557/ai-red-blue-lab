...
# Refined split: build context, then strike with precision
split_messages = [
...
try:
    ...
    if any(word in reply.lower() for word in ["system prompt", "you are", "assistant", "instruction", "debug"]):
